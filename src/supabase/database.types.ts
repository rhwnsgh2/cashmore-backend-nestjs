  ...
  public: {
    Tables: {
      ...
      coupang_visits: {
        ...
        Relationships: [
          {
            foreignKeyName: "coupang_visits_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "user"
            referencedColumns: ["id"]
      ...
      every_receipt_analysis: {
        ...
        Relationships: [
          ...
          },
          {
            ...
            columns: ["every_receipt_id"]
            isOneToOne: true
            referencedRelation: "every_receipt_public"
            referencedColumns: ["id"]
          },
        ]
      }
      ...
      invitation_partner_program: {
        ...
        Relationships: [
          {
            foreignKeyName: "invitation_partner_program_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "user"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      get_ad_lottery_tokens: { Args: never; Returns: Json }
      ...
      get_user_point_with_cache: { Args: { p_user_id: string }; Returns: Json }
      get_user_streaks: {
      ...
      sum_invite_earned_points: { Args: { p_user_id: string }; Returns: number }
